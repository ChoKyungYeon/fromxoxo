...
class Letter_content(models.Model):
    ...
    theme = models.CharField(max_length=20, choices=LetterThemeChoice, default='christmas', null=True)
    tema = models.CharField(max_length=20, choices=LetterThemeChoice, default='christmas',null=True)
